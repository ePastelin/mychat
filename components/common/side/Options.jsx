  ...
  const options = [
    {
      ...
      icon: (
        <div className='z-10'>
          {unreadMessages ? (
            <div className='rounded-full bg-notification w-6 h-6 mt-1 text-center text-white text-sm flex items-center justify-center absolute translate-x-8 -translate-y-4 animate-scaleIn'>
    ...
    },
    {
      ...
      text: 'Dashboard',
      number: 5,
      icon: <FaRegChartBar className='text-3xl text-text-50 z-10' />,
    },
  ]
