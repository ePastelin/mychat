...
export default function Create({ setScreen }) {
  ...
  const isFormValid = () => {
    return templateName.trim() !== '' && bodyProps.bodyText.trim() !== '' && headerProps.headerText.trim() !== '' && language && category
  }

  return (
    <>
      <div className='md:col-span-7 pl-4 content-center pt-8'>
        ...
        {sent && <p className='mt-4 text-green-500'>¡Plantilla enviada con éxito!</p>}
      </div>
      ...
      <section className='md:col-span-4 flex-col items-center px-6 mt-4'>
        ...
        <Preview {...headerProps} {...bodyProps} {...footerProps} buttons={buttonsProps.buttons} />
